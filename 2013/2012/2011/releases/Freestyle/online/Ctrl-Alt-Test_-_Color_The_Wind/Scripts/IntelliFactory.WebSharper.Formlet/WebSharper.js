...
{
 var global=this;
 var Append,ArrayModule,Attr,Base,BaseFormlet,Body,Choose,Class,Controls,Core,CssConstants,Data,Default,Dictionary_2,Do,ElementButton,ElementStore_1,Enhance,Events,FSharpEvent_1,FSharpList_1,FormButtonConfiguration,FormContainerConfiguration,FormRowConfiguration,Form_2,Formlet,Formlet_1,Formlet_2,InTable,InputButton,InputControl,InputField,LabelConfiguration,Layout,LiftResult,ManyConfiguration,Map,MapBody,MapIndexed,MapOption,MapResult,Map_1,Maybe,NewElementStore,NewFail,NewRecord,NewSuccess,NewUnion,Of,OfArray,OfElement,OfSeq,OfSeq_1,OnAfterRender,Padding,Padding_1,PropagateRenderFrom,RX,Reduce,Result_1,Return,SeqModule,State_1,Tags,Tree,TryPick,Tupled,Utils,UtilsProvider,ValidationFrameConfiguration,ValidationIconConfiguration,WithLabel,WithLabel_1,WithLayout,__10,__11,__12,__13,__14,__5,__50,__51,__52,__53,__54,__55,__56,__57,__58,__59,__6,__60,__61,__62,__63,__64,__65,__66,__67,get_Default,get_Default_1,op_LessMultiplyGreater,op_MinusLess;
 ...
 },MakeRow:function(rowConfig,rowIndex,body)
 {
     ...
     return function(b)
     {
      return function(csp)
      {
       return function(valign_1)
       {
        ...
        {
         var __16,__17,__18,__19,__20,__21,__22,__23,__24,__8,__9,colSpan,paddingStyle,style,valignStyle;
         __9=(OfArray())(["padding-left: "+l.toString(),"padding-top: "+t.toString(),"padding-right: "+r.toString(),"padding-bottom: "+b.toString()]);
         __8=function(source)
         {
         ...
         __16=function(o)
         {
          return(Maybe())("",function(valign)
          {
           ...
           if(valign.$==1)
            ...
            {
             __15=valign.$==2?"bottom":"top";
            }
           return"vertical-align: "+__15+";";
          },o);
         };
         valignStyle=__16(valign_1);
         __17=Attr();
         __18=paddingStyle+";"+valignStyle;
         style=__17.NewAttr("style",__18);
         if(csp)
          {
           __19=Attr();
           __20=(OfArray())([__19.NewAttr("colspan","2")]);
          }
         else
          {
           __20=(NewUnion())(FSharpList_1(),0);
          }
         colSpan=__20;
         __23=function(x)
         {
          var __15;
          __15=Tags();
          return __15.NewTag("td",x);
         };
         __21=(NewUnion())(FSharpList_1(),1,style,colSpan);
         __22=(OfArray())([elem]);
         __24=(OfSeq())((Append())(__21,__22));
         return __23(__24);
        };
       };
      };
  ...
  if(matchValue.$==1)
   {
    ...
    __26=rowConfig.LabelConfiguration;
    __25=function(o)
    {
     return(Maybe())((LabelConfiguration()).get_Default(),__13,o);
    };
    labelConf=__25(__26);
    __28=labelGen(undefined);
    __27=function(arg10)
    {
    ...
    if(matchValue_1.$==3)
     {
      __30=(InTable())((OfArray())([(OfArray())([elem_1]),(OfArray())([label])]));
      __29=(((((makeCell(paddingLeft))(paddingTop))(paddingRight))(paddingBottom))(true))({$:0});
      __35=(OfArray())([__29(__30)]);
     }
    else
     {
      if(matchValue_1.$==0)
       {
        __34=(OfArray())([((((((makeCell(paddingLeft))(paddingTop))(0))(paddingBottom))(false))({$:1,$0:labelConf.VerticalAlign}))(label),((((((makeCell(0))(paddingTop))(paddingRight))(paddingBottom))(false))({$:0}))(elem_1)]);
       }
      else
       {
        if(matchValue_1.$==1)
         {
          __33=(OfArray())([((((((makeCell(paddingLeft))(paddingTop))(0))(paddingBottom))(false))({$:1,$0:labelConf.VerticalAlign}))(elem_1),((((((makeCell(0))(paddingTop))(paddingRight))(paddingBottom))(false))({$:0}))(label)]);
         }
        else
         {
          __32=(InTable())((OfArray())([(OfArray())([label]),(OfArray())([elem_1])]));
          __31=(((((makeCell(paddingLeft))(paddingTop))(paddingRight))(paddingBottom))(true))({$:0});
          __33=(OfArray())([__31(__32)]);
         }
        __34=__33;
       }
      __35=__34;
   ...
   {
    __36=(OfArray())([((((((makeCell(paddingLeft))(paddingTop))(paddingRight))(paddingBottom))(true))({$:0}))(elem_1)]);
   }
  cells=__36;
  __38=rowConfig.Class;
  __37=function(o)
  {
  ...
  rowColorStyleProp=__39(__40);
  __42=rowConfig.Style;
  __41=function(o)
  {
  ...
  rowStyleProp=__41(__42);
  matchValue_2=(OfSeq())((Append())(rowColorStyleProp,rowStyleProp));
  if(matchValue_2.$==0)
   {
    __45=(NewUnion())(FSharpList_1(),0);
   }
  else
   {
    __44=(Reduce())(function(x)
    {
     return function(y)
     {
      return x+";"+y;
  ...
  __46=(OfSeq())((Append())(rowStyle,cells));
  __47=(OfSeq())((Append())(rowStyle,__46));
  __49=(OfSeq())((Append())(rowClass,__47));
  return __48(__49);
 ...
 (Data()).MkFormlet=function(f)
 {
  ...
  __4=function()
  {
   ...
   __2=_(__1);
   return(NewRecord())(Form_2(),{Body:__51(__2),Dispose:function()
   {
 ...
 __52=Layout();
 (Data()).UtilsProvider={Reactive:RX(),DefaultLayout:__52.get_Vertical()};
 ...
 {
  return(InputField())("text",(CssConstants()).InputTextClass,value);
 };
 (Controls()).InputField=function(typ,cls,value)
 {
  return(InputControl())(value,function(state)
  {
   var _,__1,__2,__3,__7,input;
   _=Attr();
   __1=Attr();
   __3=(OfArray())([_.NewAttr("type",typ),__1.NewAttr("class",cls)]);
   __2=Tags();
   input=__2.NewTag("input",__3);
   __7=function(arg10)
   {
    var __4;
    __4=Events();
    return __4.OnKeyUp(function()
    {
     return function()
     {
      state.Trigger({$:0,$0:input.get_Value()});
     };
    },arg10);
   };
   __7(input);
 ...
 {
  return(InputField())("password","inputPassword",value);
 };
 (Controls()).RadioButtonGroup=function(def,values)
 {
  ...
  __27=function()
  {
   var _,__1,__15,__16,__2,__20,__21,__22,__23,__24,__25,__26,__7,__8,__9,body,groupId,rbLbVls,reset,resetRB,state;
   _=Math;
   __1=Math;
   ...
   __20=function(list)
   {
    ...
    {
     var __17,__18,__19,__3,__4,inp,label,value;
     label=tupledArg[0];
     value=tupledArg[1];
     __3=Attr();
     __4=Attr();
 ...
 (Controls()).Checkbox=function(def)
 {
  ...
  __20=function()
  {
   var _,__1,__17,__18,__19,__2,__3,body,objectArg,objectArg_1,reset,state;
   state=(NewSuccess())(def);
   _=Attr();
   __1=Attr();
   __3=(OfArray())([_.NewAttr("type","checkbox"),__1.NewAttr("class","inputCheckbox")]);
   __2=Tags();
   __18=__2.NewTag("input",__3);
   __17=function(arg10)
   {
    var __4;
    __4=Events();
    return __4.OnClick(function(cb)
    {
     return function()
     {
      var __15,__16,__7,__8,__9;
      __7=cb.Body;
      __8=jQuery(__7);
      __9=__8.prop("checked");
      __16=__60(__9);
      __15=function(arg00)
      {
   ...
   reset=function()
   {
    var __4,objectArg_2,objectArg_3,objectArg_4;
    if(def)
     {
  ...
  return(InputControl())(value,function(state)
  {
   ...
   __3=function(arg10)
   {
    ...
    return __2.OnKeyUp(function()
    {
     return function()
     {
      return state.Trigger({$:0,$0:input.get_Value()});
     };
    },arg10);
   };
   __3(input);
 ...
 (Controls()).Select=function(def,vls)
 {
  ...
  __20=function()
  {
   var _,__1,__16,__17,__18,__19,__2,__3,aVls,body,reset,sIx,sValue,state;
   _=function(list)
   {
    return(OfSeq())((Map())((Tupled())(__58),list));
   };
   __2=_(vls);
   __1=function(list)
   {
 ...
 (Enhance()).WithCustomFormContainer=function(fc,formlet)
 {
  ...
  {
   return(Formlet_2()).MapElement(function(formEl)
   {
    ...
    __33=(OfArray())([["background-color",__26(__27)],["padding-left",__65(__28)],["padding-right",__65(__29)],["padding-top",__65(__30)],["padding-bottom",__65(__31)]]);
    __32=function(list)
    {
 ...
 (Enhance()).WithCustomSubmitButton=function(buttonConf,formlet)
 {
  ...
  if(matchValue.$==0)
   {
    _={Label:{$:1,$0:"Submit"},Style:buttonConf.Style};
   }
  else
   {
    _=buttonConf;
 ...
 (Enhance()).WithSubmitFormlet=function(formlet,submit)
 {
  ...
  __1=builder_.Delay(function()
  {
   var _;
   _=__56(formlet);
   return builder_.Bind(__55(_),function(_arg5)
   {
 ...
 (Enhance()).InputButton=function(conf,enabled)
 {
  ...
  __18=function()
  {
   var _,__1,__15,__16,__17,__2,__3,__4,__9,count,label,matchValue,objectArg,objectArg_1,reset,state,style,submit,submit_1;
   state=(NewFail())();
   count={contents:0};
 ...
 (Enhance()).WithCustomResetButton=function(buttonConf,formlet)
 {
  ...
  if(matchValue.$==0)
   {
    _={Label:{$:1,$0:"Reset"},Style:buttonConf.Style};
   }
  else
   {
    _=buttonConf;
 ...
 (Enhance()).WithSubmitAndResetButtons=function(formlet_1)
 {
  ...
  _=function(formlet)
  {
   ...
   return(Enhance()).WithCustomSubmitAndResetButtons({Label:{$:1,$0:"Submit"},Style:inputRecord.Style},{Label:{$:1,$0:"Reset"},Style:inputRecord_1.Style},formlet);
  };
  return _(formlet_1);
 };
 ...
 (Enhance()).WithSubmitAndReset=function(formlet,submReset)
 {
  ...
  __3=builder_.Delay(function()
  {
   ...
   _=__56(formlet);
   __1=__55(_);
   return builder_.Bind(__67(__1),(Tupled())(function(_arg6)
   {
    var notify,res;
    res=_arg6[0];
    notify=_arg6[1];
